...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/admin/cases/{id}/distribute/rewind', [AdminCaseController::class, 'rewindUnresolvedToInventory'])->name('admin.cases.distribute.rewind');
    ...
    Route::get('/admin/cases/{id}/assets/{itemId}/comments', [AdminCaseController::class, 'assetComments'])->name('admin.cases.assets.comments');
    Route::post('/admin/cases/{id}/assets/{itemId}/comments', [AdminCaseController::class, 'storeAssetComment'])->name('admin.cases.assets.comments.store');
    Route::get('/admin/cases/{id}/assets/{itemId}/comments/{commentId}/responses', [AdminCaseController::class, 'assetCommentResponses'])->name('admin.cases.assets.commentResponses');
    Route::post('/admin/cases/{id}/assets/{itemId}/comments/{commentId}/responses', [AdminCaseController::class, 'storeAssetCommentResponse'])->name('admin.cases.assets.commentResponses.store');
    Route::get('/admin/cases/{id}/assets/{itemId}/timeline', [AdminCaseController::class, 'assetTimeline'])->name('admin.cases.assets.timeline');
    Route::get('/admin/cases/{id}/comments', [AdminCaseController::class, 'caseComments'])->name('admin.cases.comments');
    Route::post('/admin/cases/{id}/comments', [AdminCaseController::class, 'storeCaseComment'])->name('admin.cases.comments.store');
    Route::get('/admin/cases/{id}/comments/{commentId}/responses', [AdminCaseController::class, 'caseCommentResponses'])->name('admin.cases.commentResponses');
    Route::post('/admin/cases/{id}/comments/{commentId}/responses', [AdminCaseController::class, 'storeCaseCommentResponse'])->name('admin.cases.commentResponses.store');
    Route::post('/admin/cases/{id}/comments/{commentId}/like', [AdminCaseController::class, 'likeCaseComment'])->name('admin.cases.comments.like');
    Route::delete('/admin/cases/{id}/comments/{commentId}/like', [AdminCaseController::class, 'unlikeCaseComment'])->name('admin.cases.comments.unlike');
